...
pub fn get(conn: postgres::Client) -> Result<PGStream, HecateError> {
...
pub fn query(read_conn: postgres::Client, query: &str, limit: &Option<i64>) -> Result<PGStream, HecateError> {
